...
CREATE TABLE `conocimientos_adicionales` (
  ...
  PRIMARY KEY (`id`),
  KEY `conocimientos_adicionales_cv_id_foreign` (`cv_id`),
  CONSTRAINT `conocimientos_adicionales_cv_id_foreign` FOREIGN KEY (`cv_id`) REFERENCES `cvs` (`id`) ON DELETE CASCADE

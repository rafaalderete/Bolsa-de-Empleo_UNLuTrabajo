  ...
  <div class="row">
    <div id="breadcrumb" class="col-xs-12">
      <ol class="breadcrumb">
        ...
        <li><a>Listado de Conocimientos de Idiomas</a></li>
      </ol>
    </div>
  </div>
...
<div class="row" style="margin-top:-20px">
  ...
  <div class="box no-box-shadow">
    ...
    <div class="box-content dropbox">
      <h4 class="page-header">Listado Conocimientos de Idiomas
        @if(true)
          <a href="{{ route('in.gestionar-cv.conocimientos-idiomas.create') }}"  style="margin-top: -5px" class="btn btn-info pull-right btn-registrar-3">

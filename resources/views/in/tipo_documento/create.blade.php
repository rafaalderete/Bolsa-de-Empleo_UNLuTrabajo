...
@section('headTitle', 'Tipo Documento | Registrar Tipo Documento')
...
@section('bodyIndice')
  ...
  <div class="row">
    <div id="breadcrumb" class="col-xs-12">
      <ol class="breadcrumb">
        <li><a>Tipo Documentol</a></li>
        <li><a>Registrar Tipo Documento</a></li>
      </ol>
    </div>
  </div>
  ...
  <div class="row" style="margin-top:-20px">
    ...
    <div class="box">
      ...
      <div class="box-content dropbox">
        <h4 class="page-header">Registro de Tipo Documento</h4>
        ...
        <a href="{{ route('in.tipo_documentol.index') }}"  style="margin-top: -5px" class="btn btn-info pull-right">

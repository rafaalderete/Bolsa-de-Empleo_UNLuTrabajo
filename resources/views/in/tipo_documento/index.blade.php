...
@section('headTitle', 'UNLu Trabajo | Tipos de Documento | Listado de Tipos de Documento')
  ...
  <div class="row">
    <div id="breadcrumb" class="col-xs-12">
      <ol class="breadcrumb">
        ...
        <li><a>Listado de Tipos de Documento</a></li>
      </ol>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="box" style="margin-top: -20px">
      ...
      <div class="box-content dropbox">
        ...
        <h4 class="page-header">Listado de Tipos de Documento
          ...
          <tbody>
            @foreach( $tipos_documento as $tipo_documento)
              <tr>
                ...
                <td>
                  @if(Entrust::can('modificar_tipo_documento'))
                    <a href="{{ route('in.tipo_documento.edit', $tipo_documento->id) }}" class="btn btn-primary"><span class="fa fa-pencil" aria-hidden="true"></span></a>
                  @endif
                  @if(Entrust::can('eliminar_tipo_documento'))
                    {!! Form::open(['route' => ['in.tipo_documento.destroy', $tipo_documento->id], 'method' => 'DELETE', 'style' => "display: inline-block"]) !!}
                    <a href="" class="btn btn-danger" data-toggle="modal" data-target="#delSpk" data-title="Eliminar Tipo Documento"
                      data-message="¿Seguro que quiere eliminar el Tipo Documento {{$tipo_documento->nombre_tipo_documento}}?"><span class=" fa fa-trash-o" aria-hidden="true"></span></a>
                    {!! Form::close() !!}
                  @endif
                  </td>
                </tr>

  ...
  <div class="row" style="margin-top:-20px">
    ...
    <div class="box">
      ...
      <div class="box-content dropbox">
        <h4 class="page-header">Registro de Nivel Educativo</h4>
        ...
        <!-- Formulario -->
        {!! Form::open(['route' => 'in.nivel_educativo.store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}

          <div class="form-group">
            {!! Form::label('nombre_nivel_educativo','Nombre Nivel Educativo', ['class' => 'col-sm-2 control-label']) !!}
            <div class="col-sm-4">
              {!! Form::text('nombre_nivel_educativo',null,['class' => 'form-control', 'placeholder' => 'Nombre Nivel Educativo', 'required'])!!}
            </div>
          </div>

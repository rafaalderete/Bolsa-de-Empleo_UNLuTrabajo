...
@section('headTitle', 'UNLu Trabajo | Mis Postulaciones')
            ...
            @endif
              ...
              @if ($busqueda)
                <div class="elminar-filtro">
                  <a href={{ route('in.mis-postulaciones') }}>Eliminar Filtro<span class="glyphicon glyphicon-remove"></span></a>
                </div>
              @endif
            </div>
          </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#buscar').keypress(function (e) {
        ...
        {
          e.preventDefault();
          $(this).val($(this).val().replace(/[^a-zA-Z0-9+ .áÁéÉíÍóÓúÚñÑ-]/g, ""));
